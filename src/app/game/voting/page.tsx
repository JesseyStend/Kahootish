        ...
        <div className="flex gap-4">
          ...
          <Card className="relative">
            <span className="absolute left-[-25px]">
              <svg
                className="fill-card translate-y-[25px] translate-x-[5px] rotate-90"
                width="30"
                height="15"
                viewBox="0 0 30 10"
        ...
        <div className="flex gap-4">
          <Card className="relative shadow-cartoon-mirrored-x">
            <span className="absolute right-[-25px]">
              <svg
                className="fill-card translate-y-[25px] translate-x-[-3px] rotate-[270deg]"
                width="30"
                height="15"
                viewBox="0 0 30 10"
                preserveAspectRatio="none"
